...
import { CastgroupModule } from '../castgroup.module';

@Injectable({
  providedIn: CastgroupModule
})
export class IncompleteDocsService {
  ...
  //   this.searchService
  //     .searchByQueryBody(gino)
  //     .subscribe((nodi: ResultSetPaging) => {
  //       this.configArray = [];
